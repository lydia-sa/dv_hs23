...
def expand_contractions(text, contraction_mapping=CONTRACTION_MAP):
    ...
    expanded_text = contractions_pattern.sub(expand_match,
                                             text)  # expand match wird für jeden match aufgerufen | sub = Muster/Funktion wird durch einen anderen Wert ersetzt. Für jedes Pattern wird die Funktion aufgerufen und der passende Match genommen.
